...
# 4. Only select unique cities from that array
  ...
  def destinations(fly_from_1, fly_from_2, date)
    ...
    depart_1_city_price = depart_1["data"].map do |info1|
      {
        ...
        price_1: info1["price"],
        city_to_1: info1["cityTo"],
        country_to_1: info1["countryTo"]["name"],
    ...
    depart_1_filtered = depart_1_city_price.uniq {|info1| info1[:price_1] }
    ...
    depart_2_city_price = depart_2["data"].map do |info2|
      {
        ...
        price_2: info2["price"],
        city_to_2: info2["cityTo"],
        country_to_2: info2["countryTo"]["name"],
    ...
    depart_2_filtered = depart_2_city_price.uniq {|info2| info2[:price_2] }
    ...
    depart_1_filtered.each do |info1|
      ...
      depart_2_filtered.each do |info2|
        ...
        if fly_to_2 == fly_to_1
          ...
          results_matched << {city_to_1: info1[:city_to_1],
                              fly_to_1: info1[:fly_to_1],
                              country_to_1: info1[:country_to_1],
                              price_1: info1[:price_1],
                              price_2: info2[:price_2],
                              total_price: total_price,
                              local_departure_1: info1[:local_departure_1],
                              local_arrival_1: info1[:local_arrival_1],
                              duration_1: info1[:duration_1],
                              airlines_1: info1[:airlines_1],
                              deep_link_1: info1[:deep_link_1],
                              has_airport_change_1: info1[:has_airport_change_1],
                              local_departure_2: info2[:local_departure_2],
                              local_arrival_2: info2[:local_arrival_2],
                              duration_2: info2[:duration_2],
                              airlines_2: info2[:airlines_2],
                              deep_link_2: info2[:deep_link_2],
                              has_airport_change_2: info2[:has_airport_change_2]
                            }
        end
      end
    end
